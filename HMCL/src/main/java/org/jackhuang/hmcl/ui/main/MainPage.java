...
public final class MainPage extends StackPane implements DecoratorPage {
...

    {
        ...
        announcementPane = net.burningtnt.hmclprs.hooks.PRCollectionRuntime.onBuildAnnouncementPane(getChildren());
        net.burningtnt.hmclprs.hooks.PRCollectionBootstrap.importRef(Cursor.class, BorderPane.class, TextFlow.class, ContainerAnimations.class);
